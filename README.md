 ...
 * ***Принцип работы сиамской сети*** 
 ...
 <img src="block_scheme.png" width ="500"/>
 </div>
...
<div id ="header" align="center">
 <img src="form2.png" width ="300"/>
 </div>	


где   – функция активации; b – смещение.
На выходе каждой из параллельных ветвей формируется вектор  ![alt text](form3.png). 
...
Обучение производилось в течение **15** эпох, значение метрики **accuracy = 0.99**, **loss = 0.0275**.
 ...
 <div id ="header" align="center">
 <img src="output1.png" width ="1000"/>
 </div>
